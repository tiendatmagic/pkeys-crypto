      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Exploring the vast universe of Bitcoin Cash keys. 
            Bitcoin Cash uses the same secp256k1 derivation as Bitcoin but with CashAddr formatting.
            There are 2<sup>256</sup> keys represented as <span className="break-all font-mono text-sm opacity-80">{BCH_MAX_PAGES.toString()}</span> pages.
          </p>
        </div>
